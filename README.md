...
Currently only support CUDA, and only tested on Ubuntu 22.04 x86_64 with CUDA 11.8. Other Debian-based Linux or ARM64 arch may also work, try it yourself!
...
PyTorch_For_PoorGuys is a Hack version of PyTorch and now maintained by [UEFI-code(Shizhuo Zhang)](https://github.com/UEFI-code).
